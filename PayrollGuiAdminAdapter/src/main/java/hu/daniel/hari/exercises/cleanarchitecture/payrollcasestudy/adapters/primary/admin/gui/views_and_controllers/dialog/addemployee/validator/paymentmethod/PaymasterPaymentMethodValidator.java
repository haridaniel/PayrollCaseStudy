...
public class PaymasterPaymentMethodValidator extends AbstractFieldsValidator<PaymasterPaymentMethod> {
	@Override
	protected void addErrors(PaymasterPaymentMethod model) {
	}
}
