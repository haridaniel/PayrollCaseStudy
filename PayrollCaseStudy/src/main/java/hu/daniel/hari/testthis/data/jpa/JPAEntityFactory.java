...
import hu.daniel.hari.testthis.data.jpa.proxy.affiliation.NoAffiliationProxy;
import hu.daniel.hari.testthis.data.jpa.proxy.affiliation.unionmember.ServiceChargeProxy;
import hu.daniel.hari.testthis.data.jpa.proxy.affiliation.unionmember.UnionMemberAffiliationProxy;
import hu.daniel.hari.testthis.data.jpa.proxy.paymentclassification.CommissionedPaymentClassificationProxy;
import hu.daniel.hari.testthis.data.jpa.proxy.paymentclassification.HourlyPaymentClassificationProxy;
import hu.daniel.hari.testthis.data.jpa.proxy.paymentclassification.SalariedPaymentClassificationProxy;
import hu.daniel.hari.testthis.data.jpa.proxy.paymentclassification.commissioned.SalesReceiptProxy;
import hu.daniel.hari.testthis.data.jpa.proxy.paymentclassification.hourly.TimeCardProxy;
import hu.daniel.hari.testthis.data.jpa.proxy.paymentmethod.DirectPaymentMethodProxy;
import hu.daniel.hari.testthis.data.jpa.proxy.paymentmethod.HoldPaymentMethodProxy;
import hu.daniel.hari.testthis.data.jpa.proxy.paymentschedule.BiWeeklyPaymentScheduleProxy;
import hu.daniel.hari.testthis.data.jpa.proxy.paymentschedule.MonthlyPaymentScheduleProxy;
import hu.daniel.hari.testthis.data.jpa.proxy.paymentschedule.WeeklyPaymentScheduleProxy;
